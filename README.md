...
Notes:
- `MANIFEST_LOGO_URL` defaults to `https://img.icons8.com/?size=100&id=43669&format=png&color=000000`. Set `MANIFEST_LOGO_URL=none` to hide the logo, or set any explicit HTTPS logo URL.
